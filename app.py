...
from database import load_jobs_from_db, load_job_from_db, add_application_to_db,  load_admin_from_db, add_job_to_db, delete_job_from_db, load_apps_from_db, delete_app_from_db, approve_app_in_db, update_job_to_db, load_app_from_db
...
#
@app.route("/approveapp/<id>",methods = ['POST','GET'])
def send_email(id):
        
        applicant = load_app_from_db(id)

        email = applicant['email']
        name = applicant['full_name']
        title = applicant['job_name']
